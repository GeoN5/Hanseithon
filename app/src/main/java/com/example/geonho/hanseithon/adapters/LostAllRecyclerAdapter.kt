...
import kotlinx.android.synthetic.main.item_lost_cardview.view.*


class LostAllRecyclerAdapter(val items : List<AllData>,val context:Context) : RecyclerView.Adapter<ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView: View = LayoutInflater.from(context).inflate(R.layout.item_lost_cardview, parent, false)
